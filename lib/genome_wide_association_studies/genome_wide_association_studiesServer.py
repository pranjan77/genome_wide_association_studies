...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'genome_wide_association_studies'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from genome_wide_association_studies.genome_wide_association_studiesImpl import genome_wide_association_studies  # noqa @IgnorePep8
impl_genome_wide_association_studies = genome_wide_association_studies(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'genome_wide_association_studies'
        ...
        self.rpc_service.add(impl_genome_wide_association_studies.import_gwas_data,
