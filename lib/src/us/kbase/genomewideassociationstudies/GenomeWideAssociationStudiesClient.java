...
/**
 * <p>Original spec-file module name: genome_wide_association_studies</p>
 * <pre>
 * A KBase module: genome_wide_association_studies
 * </pre>
 */
public class GenomeWideAssociationStudiesClient {
     ...
     */
    public GenomeWideAssociationStudiesClient(URL url) {
     ...
     * validity.
     */
    public GenomeWideAssociationStudiesClient(URL url, AuthToken token) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public GenomeWideAssociationStudiesClient(URL url, String user, String password) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public GenomeWideAssociationStudiesClient(URL url, String user, String password, URL auth) throws UnauthorizedException, IOException {
    ...
    /**
     * <p>Original spec-file function name: import_gwas_data</p>
     * <pre>
     * </pre>
     * @param   arg1   instance of type {@link us.kbase.genomewideassociationstudies.ImportGwasDataParams ImportGwasDataParams} (original type "import_gwas_data_params")
     * @return   instance of type {@link us.kbase.genomewideassociationstudies.RunImportGwasDataResult RunImportGwasDataResult} (original type "Run_import_gwas_data_result")
     * @throws IOException if an IO exception occurs
     * @throws JsonClientException if a JSON RPC exception occurs
     */
    public RunImportGwasDataResult importGwasData(ImportGwasDataParams arg1, RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        List<Object> args = new ArrayList<Object>();
        args.add(arg1);
        TypeReference<List<RunImportGwasDataResult>> retType = new TypeReference<List<RunImportGwasDataResult>>() {};
        List<RunImportGwasDataResult> res = caller.jsonrpcCall("genome_wide_association_studies.import_gwas_data", args, retType, true, true, jsonRpcContext, this.serviceVersion);
        return res.get(0);
    }
    ...
    public Map<String, Object> status(RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<Map<String, Object>> res = caller.jsonrpcCall("genome_wide_association_studies.status", args, retType, true, false, jsonRpcContext, this.serviceVersion);
        return res.get(0);
    }
}
